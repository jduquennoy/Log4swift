...
An xcode 8 beta 4 / swift 3 version is also available in branch **xcode8-beta**. Note that this branch requires Xcode8 beta 4, it will not compile with previous beta.
