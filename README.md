...
* straitforward to use for simple cases : default configuration should just work, one-line configuration for simple, typical uses like logging to IDE console or to system logs
