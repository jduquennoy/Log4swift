...
An xcode 8 beta 6 / swift 3 version is also available in branch **xcode8-beta**. Note that this branch requires Xcode8 beta 6, it will not compile with previous beta.
